...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.CreatedTs = field.NewTime(tableName, "created_ts")
	_tag.ModifiedTs = field.NewTime(tableName, "modified_ts")
	_tag.DeletedTs = field.NewTime(tableName, "deleted_ts")
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.CreatedTs = field.NewTime(table, "created_ts")
	t.ModifiedTs = field.NewTime(table, "modified_ts")
	t.DeletedTs = field.NewTime(table, "deleted_ts")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["created_ts"] = t.CreatedTs
	t.fieldMap["modified_ts"] = t.ModifiedTs
	t.fieldMap["deleted_ts"] = t.DeletedTs
}
