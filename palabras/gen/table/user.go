...
func newUserTableImpl(schemaName, tableName, alias string) userTable {
	var (
		...
		IsActiveColumn  = sqlite.FloatColumn("is_active")
		CreatedAtColumn = sqlite.TimestampColumn("created_at")
		UpdatedAtColumn = sqlite.TimestampColumn("updated_at")
		DeletedAtColumn = sqlite.TimestampColumn("deleted_at")
		allColumns      = sqlite.ColumnList{IDColumn, EmailColumn, IsActiveColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn}
		mutableColumns  = sqlite.ColumnList{EmailColumn, IsActiveColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn}
	)
